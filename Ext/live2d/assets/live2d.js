...
function(t) {
	...
	function o(t) {
		if(!document.getElementById(live2DBoxName)){
			C = document.getElementById(t), C.addEventListener && (window.addEventListener("click", g), window.addEventListener("mousedown", g),window.addEventListener("mousemove", g), window.addEventListener("mouseup", g), document.addEventListener("mouseout", g), window.addEventListener("touchstart", y), window.addEventListener("touchend", y), window.addEventListener("touchmove", y))//3
		}else{			
			C = document.getElementById(t), C.addEventListener && (document.getElementById(live2DBoxName).addEventListener("click", g), document.getElementById(live2DBoxName).addEventListener("mousedown", g),document.getElementById(live2DBoxName).addEventListener("mousemove", g), document.getElementById(live2DBoxName).addEventListener("mouseup", g), document.getElementById(live2DBoxName).addEventListener("mouseout", g), document.getElementById(live2DBoxName).addEventListener("touchstart", y), document.getElementById(live2DBoxName).addEventListener("touchend", y), document.getElementById(live2DBoxName).addEventListener("touchmove", y))//3
		}
	}
	function n(t) {
		var i = C.width,
